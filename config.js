...
const banmsgtype = '*Fuja seu Membro comum, o ban está atrás de você*'
// mensagem de ban no anti tipos de mensagem

const adminmsgtype = '*Ia te banir mas adm pode enviar msg proibida*'
// mensagem de quando adm manda tipos de mensagens proibidas

const banmsgporn = 'Hmmm pornozinho com antiporn ativado, ja sabe né... Fuja Membro comum'
// mensagem de ban no antiporn

const adminmsgporn = '*Adm pode enviar porn*'
// mensagem de quando adm manda porn com antiporn ativado

const banmsglink = 'Hmmm link né, O ban está próximo membro comum...'
// mensagem de ban no antilink

const adminmsglink = 'Adm pode enviar link avontade hehe 🙃'
// mensagem de quando adm manda link

const adminmsgpalavra = 'isso esta na lista das palavras proibidas pelo bot'
// mensagem de quando adm manda uma palavra proibida pelo bot

const banmsgpalavra = 'Palavra proibida? Já sabe né membro comum'
...
const textmsgday = 'Ohayo Onii-chan 👉👈'
...
const apiTobz = 'MDQs9BlugXti7BcRfZsf'
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=556799595567:+55 67 9959-5567\n' 
+ 'END:VCARD'
